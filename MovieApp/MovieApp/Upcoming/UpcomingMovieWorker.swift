...
class UpcomingMovieWorker
{
  ...
  func doSomeWork()
  {
    ...
    func downloadUpcomingMovies(lang: String, page: Int, category: MovieCategory, completion2: @escaping (Bool)-> Void){
    ...
    func downloadUpcomingMoviesWithoutLag(lang: String, page: Int, category: MovieCategory, completion2: @escaping (Bool)-> Void){
        self.apiManager.fetchMovieDetails(lang: lang, page: page, category: category, completion: {
            success in
    ...
    func fetchMoviesImage(){
        ...
        for movie in DatabaseManager.upcomingMovies{
